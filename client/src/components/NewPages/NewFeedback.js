    ...
    return (
      ...
      <Navbar />
        <div className="feedback-text">
          <h5 className="feedback-text">I am always open to and appreciate feedback to expand my knowledge and skills. If you have any comments, please submit the form below.</h5>
        </div>
        <div className="row feedback-rows">
